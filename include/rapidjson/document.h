...
// number of objects that rapidjsontmp::Value allocates memory for by default
...
// number of array elements that rapidjsontmp::Value allocates memory for by default
...
/*!
    ...
    https://code.google.com/p/rapidjsontmp/issues/detail?id=64
*/
template <typename Encoding, typename Allocator> 
class GenericMember {
public:
...
public:
    ...
    */
    ...
    /*! Since rapidjsontmp permits "\\u0000" in the json string, strlen(v.GetString()) may not equal to v.GetStringLength().
    */
